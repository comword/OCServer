 ...
 */
DLL_PUBLIC void *xxtea_encrypt( const void *data, size_t len, const void *key, size_t *out_len );
 ...
 * Caller is responsible for freeing the returned buffer.
 */
DLL_PUBLIC void *xxtea_decrypt( const void *data, size_t len, const void *key, size_t *out_len );
